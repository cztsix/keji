...
public class CustomViewfinderView extends ViewfinderView {
     ...
     */
    public float mLineRate = 0.08f;

    /**
     * 边角线厚度 (建议使用dp)
     */
    public float mLineDepth =  TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 3, getResources().getDisplayMetrics());

    /**
     * 边角线颜色
     */
    public int mLineColor = Color.parseColor("#33CCFF");
     ...
     * 扫描线厚度
     */
    public float mScanLineDepth = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 2, getResources().getDisplayMetrics());
     ...
     * 线性梯度各个位置对应的颜色值
     */
    public int[] mScanLineColor = new int[]{0xff33CCFF, 0xff33CCFF, 0xff33CCFF};
