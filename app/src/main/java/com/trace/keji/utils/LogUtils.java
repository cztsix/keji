...
import com.trace.keji.BuildConfig;
...
/**
 * Created by wuzhihao on 2019/7/22.
 */

public class LogUtils {

    private static String customTagPrefix = "logs"; // 自定义Tag的前缀，可以是作者名
    ...
    private static boolean allow = BuildConfig.LOG;
